...
public class ClienteController {
    ...
    public Mono<ClienteResponseDTO> crearCliente(@Valid @RequestBody ClienteRequestDTO request) {
    ...
    public Mono<ClienteResponseDTO> obtenerCliente(@PathVariable Long id) {
    ...
    public Mono<ClienteResponseDTO> obtenerClientePorDni(@PathVariable String dni) {
    ...
    public Mono<ClienteResponseDTO> actualizarCliente(
